...
func TestLogCheckVersionMatch(t *testing.T) {
	...
	// positive test
	op.SCToHostVersionMap[""] = map[string]string{
	...
	// negative test
	op.SCToHostVersionMap = make(map[string]map[string]string)
	op.SCToHostVersionMap["default_subcluster"] = map[string]string{
		"192.168.0.101": "Vertica Analytic Database v24.1.0",
		"192.168.0.102": "Vertica Analytic Database v24.1.0",
	...
	op.SCToHostVersionMap["sc1"] = map[string]string{
	...
	op.SCToHostVersionMap["sc2"] = map[string]string{
